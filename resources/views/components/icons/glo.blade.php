<svg {{ $attributes }} xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1000 1000">
    <defs>
        <linearGradient id="a" x1="484.48" y1="319.34" x2="536.14" y2="785.87"
            gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="#123214" />
            <stop offset="0.46" stop-color="#3e7c37" />
            <stop offset="0.91" stop-color="#5fbb46" />
        </linearGradient>
        <linearGradient id="b" x1="4812.32" y1="-2121.07" x2="4812.32" y2="-2122.13"
            gradientTransform="matrix(115.64, 0, 0, -355.9, -555713.76, -754599.8)" gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="#fff" stop-opacity="0" />
            <stop offset="0.64" stop-color="#fff" stop-opacity="0.43" />
            <stop offset="1" stop-color="#fff" stop-opacity="0.42" />
        </linearGradient>
        <radialGradient id="c" cx="1772.25" cy="-341.52" fy="-409.14889841083107" r="151.52"
            gradientTransform="matrix(1.17, 0.59, -0.28, 0.47, -1527.13, -664.3)" gradientUnits="userSpaceOnUse">
        ...
        <radialGradient id="d" cx="570.86" cy="398.43" fx="613.1001782573674" fy="841.347906680515"
            r="444.93" gradientTransform="translate(410.75 -300.75) rotate(39.84) scale(1 1.09)"
            gradientUnits="userSpaceOnUse">
    ...
    <path
        ...
        style="fill-rule:evenodd;opacity:0.6629999876022339;isolation:isolate;fill:url(#a)" />
    <path
        d="M673,785.86q218.65-205.67,72.69-471.24.74.54,18.06-62.32,77.68,94.07,82.61,232.22Q846.32,663.46,673,785.86Z"
        style="fill-rule:evenodd;opacity:0.5860000252723694;isolation:isolate;fill:url(#b)" />
    <path
        ...
        style="fill-rule:evenodd;opacity:0.7440000176429749;isolation:isolate;fill:url(#c)" />
    <path
    ...
    <polygon points="447.08 284.98 523.24 284.98 523.24 588.68 481.43 588.68 481.43 318.29 447.08 318.29 447.08 284.98"
        style="fill:#fff;fill-rule:evenodd" />
    <path
